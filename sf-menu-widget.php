...
function list_vertical($args = '') {
	...
	?>
	  <style type="text/css">
		...
		.nav-side-menu .brand {background-color: <?php echo $args['title_color']; ?>;line-height: 50px;display: block;text-align: center;font-size: 14px; color:<?php echo $args['title_font']; ?>;}
		.nav-side-menu li.active a {color:<?php echo $args['items_active_font']; ?>}
		.nav-side-menu li .active,.nav-side-menu ul .active {background-color: <?php echo $args['items_active']; ?>}
		.nav-side-menu li .sub-menu li.active,.nav-side-menu ul .sub-menu li.active,.nav-side-menu li .sub-menu li.active a,.nav-side-menu ul .sub-menu li.active a {color: <?php echo $args['items_active_font']; ?>;background-color: <?php echo $args['items_active']; ?>}
	  </style>
	  <?php
	...
	if (!empty($pageids)) {	  		
		...
		$output .= wp_list_pages( Array('title_li' => '',
					...
					'walker'  => new sf_bootstrap_walker_page($args['expanded'])
				) );									
...
function list_horizontal($args = '') {
	...
	?>
	  <style type="text/css">
		...
		.nav-side-menu li .active,.nav-side-menu ul .active {background-color: <?php echo $args['items_active']; ?>}
		.nav-side-menu li.active a {color:<?php echo $args['items_active_font']; ?>}
		.nav-side-menu li .sub-menu li.active,.nav-side-menu ul .sub-menu li.active {color: <?php echo $args['items_active_font']; ?>;background-color: <?php echo $args['items_active']; ?>}
	  </style>
	  <?php
